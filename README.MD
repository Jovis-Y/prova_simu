...
**Docente:** Dr. Prof. Filipe de Oliveira Saraiva.<br>
**Discentes:** João Vitor Yokoyama Nobayashi (202204940026), Thiago Mendes de Castro Correia (202304940014), Thiago Correa de Castro (202004940005).

---

## Sumário
1. [Modelagem ACD ](#1-modelagem-acd-activity-cycle-diagram)
2. [Análise dos Cenários e Resultados das Simulações](#2-identificação-dos-gargalos-do-sistema-e-criação-de-cenários-que-reduzam-os-gargalos)
...
![Diagrama ACD do Cenário Aeroportuário](/output/modelagem_acd-1.png)
...
![resultado da simulação](/output/resultado_simulação_padrão.png)
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Cenário Padrão** | 3270.0 min | - | - | 424.82 / 457.29 | 0.00 / 0.00 | 0.00 / 1.11 | 0.13 / 0.00 | 558.16 / 628.88 |
...
extra: na pasta videos_simulação contém as simulações visuais dos 3 primeiros cenários
