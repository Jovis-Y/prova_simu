...
# ==========================================
# ==========================================
# 4. EXECUÇÃO, ANIMAÇÃO E EXPORTAÇÃO
# ==========================================
...
def gerador_frames():
    ...
    while estado_nos['Saída'] < total_aeronaves:
        yield frame
        frame += 1
    yield frame # Um frame extra para mostrar a mensagem de conclusão

# Adicionamos o 'frames=gerador_frames' e o 'save_count'
...
# ESCOLHA UMA DAS OPÇÕES ABAIXO (Comente a que não for usar):


# Opção B: Salvar como MP4 (Exige FFmpeg instalado no PC)
ani.save('simulacao_2_pista_P_e_1_pista_G_a_mais.mp4', writer='ffmpeg', fps=10)
print("Vídeo salvo como 'simulacao_aeroporto.mp4'!")